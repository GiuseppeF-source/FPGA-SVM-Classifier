...
################################################################
# This is a generated script based on design: bd_d4d3
#
...
proc create_root_design { parentCell } {
  ...
  set probe3 [ create_bd_port -dir I -from 407 -to 0 probe3 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_ILA_CLK_FREQ {30303030} \
