...
entity DSP_AxB_Cascade_wo_PCIN is
  port (
...
end DSP_AxB_Cascade_wo_PCIN;

architecture Behavioral of DSP_AxB_Cascade_wo_PCIN is
...
begin
  ...
  port map(
   ...
   P => OUT_DSP, -- 48-bit output: Primary data output
    ...
    OPMODE => "0000101", -- 7-bit input: Operation mode input  -- A*B + PCIN
