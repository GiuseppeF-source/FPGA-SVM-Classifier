...
read_vhdl -library xil_defaultlib {
  ...
  C:/Users/yoxo/OneDrive/Documenti/work_dir/Master_Degree_Thesis/PYNQ_SVM_CLASSIFIER/PYNQ_SVM_CLASSIFIER.srcs/sources_1/new/axis_to_bram_Kernel_Scale.vhd
}
...
synth_design -top axis_to_bram_Kernel_Scale -part xc7z020clg400-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef axis_to_bram_Kernel_Scale.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file axis_to_bram_Kernel_Scale_utilization_synth.rpt -pb axis_to_bram_Kernel_Scale_utilization_synth.pb"
