...
HD_PWD='C:/Users/yoxo/OneDrive/Documenti/work_dir/Master_Degree_Thesis/PYNQ_SVM_CLASSIFIER/PYNQ_SVM_CLASSIFIER.runs/embedded_system_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log embedded_system_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source embedded_system_auto_pc_0.tcl
