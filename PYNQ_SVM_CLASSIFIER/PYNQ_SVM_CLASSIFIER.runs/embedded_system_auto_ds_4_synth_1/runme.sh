...
HD_PWD='C:/Users/yoxo/Desktop/Giuseppe/Unical/CdL_LM_Tesi/Classifier_HW/PYNQ_SVM_CLASSIFIER/PYNQ_SVM_CLASSIFIER.runs/embedded_system_auto_ds_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log embedded_system_auto_ds_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source embedded_system_auto_ds_4.tcl
