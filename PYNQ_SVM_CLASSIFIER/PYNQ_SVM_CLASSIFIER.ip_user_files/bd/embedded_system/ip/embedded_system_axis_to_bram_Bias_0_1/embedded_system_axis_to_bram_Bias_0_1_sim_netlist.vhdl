...
--               c:/Users/yoxo/OneDrive/Documenti/work_dir/Master_Degree_Thesis/PYNQ_SVM_CLASSIFIER/PYNQ_SVM_CLASSIFIER.srcs/sources_1/bd/embedded_system/ip/embedded_system_axis_to_bram_Bias_0_1/embedded_system_axis_to_bram_Bias_0_1_sim_netlist.vhdl
...
entity embedded_system_axis_to_bram_Bias_0_1_AXIS_BRAM_mng is
  port (
  ...
  attribute ORIG_REF_NAME of embedded_system_axis_to_bram_Bias_0_1_AXIS_BRAM_mng : entity is "AXIS_BRAM_mng";
end embedded_system_axis_to_bram_Bias_0_1_AXIS_BRAM_mng;

architecture STRUCTURE of embedded_system_axis_to_bram_Bias_0_1_AXIS_BRAM_mng is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity embedded_system_axis_to_bram_Bias_0_1_SIPO_shift_reg_w_full is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of embedded_system_axis_to_bram_Bias_0_1_SIPO_shift_reg_w_full : entity is "SIPO_shift_reg_w_full";
end embedded_system_axis_to_bram_Bias_0_1_SIPO_shift_reg_w_full;

architecture STRUCTURE of embedded_system_axis_to_bram_Bias_0_1_SIPO_shift_reg_w_full is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity embedded_system_axis_to_bram_Bias_0_1_axis_to_bram_Bias is
  port (
    data_out : out STD_LOGIC_VECTOR ( 6 downto 0 );
    E : out STD_LOGIC_VECTOR ( 0 to 0 );
    addr_ram : out STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of embedded_system_axis_to_bram_Bias_0_1_axis_to_bram_Bias : entity is "axis_to_bram_Bias";
end embedded_system_axis_to_bram_Bias_0_1_axis_to_bram_Bias;

architecture STRUCTURE of embedded_system_axis_to_bram_Bias_0_1_axis_to_bram_Bias is
  signal \^gen_if_depth_ff.count_reg[0]\ : STD_LOGIC;
begin
  \gen_IF_DEPTH_FF.count_reg[0]\ <= \^gen_if_depth_ff.count_reg[0]\;
MNG: entity work.embedded_system_axis_to_bram_Bias_0_1_AXIS_BRAM_mng
     port map (
      addr_ram(3 downto 0) => addr_ram(3 downto 0),
      clk => clk,
...
SIPO: entity work.embedded_system_axis_to_bram_Bias_0_1_SIPO_shift_reg_w_full
     port map (
      E(0) => E(0),
      clk => clk,
...
entity embedded_system_axis_to_bram_Bias_0_1 is
  ...
  attribute NotValidForBitStream of embedded_system_axis_to_bram_Bias_0_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of embedded_system_axis_to_bram_Bias_0_1 : entity is "embedded_system_axis_to_bram_Bias_0_1,axis_to_bram_Bias,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of embedded_system_axis_to_bram_Bias_0_1 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of embedded_system_axis_to_bram_Bias_0_1 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of embedded_system_axis_to_bram_Bias_0_1 : entity is "axis_to_bram_Bias,Vivado 2018.3";
end embedded_system_axis_to_bram_Bias_0_1;

architecture STRUCTURE of embedded_system_axis_to_bram_Bias_0_1 is
...
begin
  en_ram <= \^en_ram\;
  we_ram <= \^en_ram\;
U0: entity work.embedded_system_axis_to_bram_Bias_0_1_axis_to_bram_Bias
     port map (
      E(0) => s_axis_tready,
      addr_ram(3 downto 0) => addr_ram(3 downto 0),
      clk => clk,
