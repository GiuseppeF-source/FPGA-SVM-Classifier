...
HD_PWD='C:/Users/yoxo/OneDrive/Documenti/work_dir/Master_Degree_Thesis/Progetti_prova/TEST_CDMA/TEST_CDMA.runs/design_TEST_CDMA_axi_smc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_TEST_CDMA_axi_smc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_TEST_CDMA_axi_smc_0.tcl
