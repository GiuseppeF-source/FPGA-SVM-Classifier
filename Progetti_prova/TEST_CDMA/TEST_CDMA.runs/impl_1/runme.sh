...
HD_PWD='C:/Users/yoxo/OneDrive/Documenti/work_dir/Master_Degree_Thesis/Progetti_prova/TEST_CDMA/TEST_CDMA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_TEST_CDMA_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_TEST_CDMA_wrapper.tcl -notrace
