...
HD_PWD='C:/work/Master_Degree_Thesis/HW_SVM/HW_SVM.runs/hw_svm_axi_dma_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hw_svm_axi_dma_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hw_svm_axi_dma_1_0.tcl
