...
HD_PWD='C:/work/Master_Degree_Thesis/HW_SVM/HW_SVM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hw_svm_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hw_svm_wrapper.tcl -notrace
