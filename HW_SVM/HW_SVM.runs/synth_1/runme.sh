...
HD_PWD='C:/work/Master_Degree_Thesis/HW_SVM/HW_SVM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hw_svm_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hw_svm_wrapper.tcl
