...
-- Date        : Sat Mar 18 16:38:15 2023
-- Host        : peppe-pc running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               C:/work/Master_Degree_Thesis/HW_SVM/HW_SVM.srcs/sources_1/bd/hw_svm/ip/hw_svm_axis_to_bram_Kernel_0_0/hw_svm_axis_to_bram_Kernel_0_0_sim_netlist.vhdl
...
entity hw_svm_axis_to_bram_Kernel_0_0_AXIS_BRAM_mng is
  port (
  ...
  attribute ORIG_REF_NAME of hw_svm_axis_to_bram_Kernel_0_0_AXIS_BRAM_mng : entity is "AXIS_BRAM_mng";
end hw_svm_axis_to_bram_Kernel_0_0_AXIS_BRAM_mng;

architecture STRUCTURE of hw_svm_axis_to_bram_Kernel_0_0_AXIS_BRAM_mng is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity hw_svm_axis_to_bram_Kernel_0_0_SIPO_shift_reg_w_full is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of hw_svm_axis_to_bram_Kernel_0_0_SIPO_shift_reg_w_full : entity is "SIPO_shift_reg_w_full";
end hw_svm_axis_to_bram_Kernel_0_0_SIPO_shift_reg_w_full;

architecture STRUCTURE of hw_svm_axis_to_bram_Kernel_0_0_SIPO_shift_reg_w_full is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity hw_svm_axis_to_bram_Kernel_0_0_axis_to_bram_Kernel is
  port (
    data_out : out STD_LOGIC_VECTOR ( 11 downto 0 );
    E : out STD_LOGIC_VECTOR ( 0 to 0 );
    addr_ram : out STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of hw_svm_axis_to_bram_Kernel_0_0_axis_to_bram_Kernel : entity is "axis_to_bram_Kernel";
end hw_svm_axis_to_bram_Kernel_0_0_axis_to_bram_Kernel;

architecture STRUCTURE of hw_svm_axis_to_bram_Kernel_0_0_axis_to_bram_Kernel is
  signal \^gen_if_depth_ff.count_reg[0]\ : STD_LOGIC;
begin
  \gen_IF_DEPTH_FF.count_reg[0]\ <= \^gen_if_depth_ff.count_reg[0]\;
MNG: entity work.hw_svm_axis_to_bram_Kernel_0_0_AXIS_BRAM_mng
     port map (
      addr_ram(3 downto 0) => addr_ram(3 downto 0),
      clk => clk,
...
SIPO: entity work.hw_svm_axis_to_bram_Kernel_0_0_SIPO_shift_reg_w_full
     port map (
      E(0) => E(0),
      clk => clk,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity hw_svm_axis_to_bram_Kernel_0_0 is
  port (
    clk : in STD_LOGIC;
    trig : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of hw_svm_axis_to_bram_Kernel_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of hw_svm_axis_to_bram_Kernel_0_0 : entity is "hw_svm_axis_to_bram_Kernel_0_0,axis_to_bram_Kernel,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of hw_svm_axis_to_bram_Kernel_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of hw_svm_axis_to_bram_Kernel_0_0 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of hw_svm_axis_to_bram_Kernel_0_0 : entity is "axis_to_bram_Kernel,Vivado 2018.3";
end hw_svm_axis_to_bram_Kernel_0_0;

architecture STRUCTURE of hw_svm_axis_to_bram_Kernel_0_0 is
  signal \^en_ram\ : STD_LOGIC;
  attribute x_interface_info : string;
  attribute x_interface_info of clk : signal is "xilinx.com:signal:clock:1.0 clk CLK";
  attribute x_interface_parameter : string;
  attribute x_interface_parameter of clk : signal is "XIL_INTERFACENAME clk, ASSOCIATED_BUSIF s_axis, FREQ_HZ 142857132, PHASE 0.000, CLK_DOMAIN hw_svm_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0";
  attribute x_interface_info of s_axis_tready : signal is "xilinx.com:interface:axis:1.0 s_axis TREADY";
  attribute x_interface_parameter of s_axis_tready : signal is "XIL_INTERFACENAME s_axis, TDATA_NUM_BYTES 4, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 0, FREQ_HZ 142857132, PHASE 0.000, CLK_DOMAIN hw_svm_processing_system7_0_0_FCLK_CLK0, LAYERED_METADATA undef, INSERT_VIP 0";
  attribute x_interface_info of s_axis_tvalid : signal is "xilinx.com:interface:axis:1.0 s_axis TVALID";
  attribute x_interface_info of s_axis_tdata : signal is "xilinx.com:interface:axis:1.0 s_axis TDATA";
begin
  en_ram <= \^en_ram\;
  we_ram <= \^en_ram\;
U0: entity work.hw_svm_axis_to_bram_Kernel_0_0_axis_to_bram_Kernel
     port map (
      E(0) => s_axis_tready,
      addr_ram(3 downto 0) => addr_ram(3 downto 0),
      clk => clk,
