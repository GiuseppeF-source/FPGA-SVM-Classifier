...
architecture Behavioral of DSP_AxB_Cascade is
...
begin
  ...
  port map(
   ...
   P => OUT_DSP, -- 48-bit output: Primary data output

    -- Cascade: 30-bit (each) input: Cascade Ports
    ACIN => x"0000000"&b"00", -- 30-bit input: A cascade data input
    BCIN => x"0000"&b"00", -- 18-bit input: B cascade input
    CARRYCASCIN => '0', -- 1-bit input: Cascade carry input
    MULTSIGNIN => '0', -- 1-bit input: Multiplier sign input
    PCIN => IN_Cascade, -- 48-bit input: P cascade input
    ...
    OPMODE => "0010101", -- 7-bit input: Operation mode input  -- A*B + PCIN

    -- Data: 30-bit (each) input: Data Ports
    A => Attribute_j, -- 30-bit input: A data input
    B => SV_j, -- 18-bit input: B data input
    C => x"000000000000", -- 48-bit input: C data input
    CARRYIN => '0', -- 1-bit input: Carry input signal
    D => x"000000"&b"0", -- 25-bit input: D data input
    ...
    RSTC => '1', -- 1-bit input: Reset input for CREG
