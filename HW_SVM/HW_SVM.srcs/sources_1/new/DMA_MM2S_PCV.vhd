...
architecture rtl of DMA_MM2S_PCV is

------------------------------------------
-- Signals necessary for Reading from file
------------------------------------------
constant n_32b  : natural := 208;
...
-------------------------------
read_file: process
    file text_file : text open read_mode is "C:\work\Master_Degree_Thesis\Gen_data_to_send\TB_DMA_Emul\PCV_pkt_32b_TB.h";
