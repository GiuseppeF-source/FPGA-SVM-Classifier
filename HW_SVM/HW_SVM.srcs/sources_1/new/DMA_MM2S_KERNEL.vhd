...
architecture rtl of DMA_MM2S_KERNEL is

------------------------------------------
-- Signals necessary for Reading from file
------------------------------------------
constant n_32b  : natural := 16;
type array_of_std is array (0 to n_32b) of std_logic_vector(32 - 1 downto 0);
...
-------------------------------
read_file: process
    file text_file : text open read_mode is "C:\work\Master_Degree_Thesis\Gen_data_to_send\TB_DMA_Emul\Kernel_Scale_pkt_32b_TB.h";
