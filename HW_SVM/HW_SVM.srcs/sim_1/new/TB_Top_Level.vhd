...
signal  axi_resetn_i                   : std_logic; -- reset Active Low                                  
...
-- RAM Kernel Scale                   
signal  bram_addr_Kernel_Scale         : std_logic_vector( ADDR_WIDTH-1 downto 0 ); -- da utilizzare solo i primi 4bit       
signal  bram_wrdata_Kernel_Scale       : std_logic_vector( KERNEL_DATA_WIDTH -1 downto 0 ); -- dimensione axi full da portare a 12   
signal  bram_en_Kernel_Scale           : std_logic;                                                                
signal  bram_we_Kernel_Scale           : std_logic;                                           
-- RAM Bias                           
signal  bram_addr_Bias                 : std_logic_vector( ADDR_WIDTH-1 downto 0 ); -- da utilizzare solo i primi 4          
signal  bram_wrdata_Bias               : std_logic_vector( BIAS_DATA_WIDTH -1 downto 0 ); -- dimensione axi full da portare a 7    
...
begin
    ...
    generic map (
        n_in_bit => AXIS_DATA_WIDTH,
        n_out_bit => PCV_DATA_WIDTH
    )
    port map (
        clk => m00_axis_aclk,
