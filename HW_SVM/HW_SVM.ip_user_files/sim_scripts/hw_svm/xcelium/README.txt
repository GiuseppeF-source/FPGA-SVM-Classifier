...
#
# Generated by export_simulation on Wed Dec 28 19:25:23 +0100 2022
#
################################################################################
...
'-reset_run' switch to the './hw_svm.sh' script.
...
./hw_svm.sh -noclean_files

For more information on the script, please type './hw_svm.sh -help'.
