...
-- Date        : Sat Mar 18 16:38:30 2023
-- Host        : peppe-pc running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               C:/work/Master_Degree_Thesis/HW_SVM/HW_SVM.srcs/sources_1/bd/hw_svm/ip/hw_svm_axis_to_bram_Bias_0_0/hw_svm_axis_to_bram_Bias_0_0_sim_netlist.vhdl
...
entity hw_svm_axis_to_bram_Bias_0_0_AXIS_BRAM_mng is
  port (
  ...
  attribute ORIG_REF_NAME of hw_svm_axis_to_bram_Bias_0_0_AXIS_BRAM_mng : entity is "AXIS_BRAM_mng";
end hw_svm_axis_to_bram_Bias_0_0_AXIS_BRAM_mng;

architecture STRUCTURE of hw_svm_axis_to_bram_Bias_0_0_AXIS_BRAM_mng is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity hw_svm_axis_to_bram_Bias_0_0_SIPO_shift_reg_w_full is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of hw_svm_axis_to_bram_Bias_0_0_SIPO_shift_reg_w_full : entity is "SIPO_shift_reg_w_full";
end hw_svm_axis_to_bram_Bias_0_0_SIPO_shift_reg_w_full;

architecture STRUCTURE of hw_svm_axis_to_bram_Bias_0_0_SIPO_shift_reg_w_full is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity hw_svm_axis_to_bram_Bias_0_0_axis_to_bram_Bias is
  port (
    data_out : out STD_LOGIC_VECTOR ( 6 downto 0 );
    E : out STD_LOGIC_VECTOR ( 0 to 0 );
    addr_ram : out STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of hw_svm_axis_to_bram_Bias_0_0_axis_to_bram_Bias : entity is "axis_to_bram_Bias";
end hw_svm_axis_to_bram_Bias_0_0_axis_to_bram_Bias;

architecture STRUCTURE of hw_svm_axis_to_bram_Bias_0_0_axis_to_bram_Bias is
  signal \^gen_if_depth_ff.count_reg[0]\ : STD_LOGIC;
begin
  \gen_IF_DEPTH_FF.count_reg[0]\ <= \^gen_if_depth_ff.count_reg[0]\;
MNG: entity work.hw_svm_axis_to_bram_Bias_0_0_AXIS_BRAM_mng
     port map (
      addr_ram(3 downto 0) => addr_ram(3 downto 0),
      clk => clk,
...
SIPO: entity work.hw_svm_axis_to_bram_Bias_0_0_SIPO_shift_reg_w_full
     port map (
      E(0) => E(0),
      clk => clk,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity hw_svm_axis_to_bram_Bias_0_0 is
  port (
    clk : in STD_LOGIC;
    trig : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of hw_svm_axis_to_bram_Bias_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of hw_svm_axis_to_bram_Bias_0_0 : entity is "hw_svm_axis_to_bram_Bias_0_0,axis_to_bram_Bias,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of hw_svm_axis_to_bram_Bias_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of hw_svm_axis_to_bram_Bias_0_0 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of hw_svm_axis_to_bram_Bias_0_0 : entity is "axis_to_bram_Bias,Vivado 2018.3";
end hw_svm_axis_to_bram_Bias_0_0;

architecture STRUCTURE of hw_svm_axis_to_bram_Bias_0_0 is
...
begin
  en_ram <= \^en_ram\;
  we_ram <= \^en_ram\;
U0: entity work.hw_svm_axis_to_bram_Bias_0_0_axis_to_bram_Bias
     port map (
      E(0) => s_axis_tready,
      addr_ram(3 downto 0) => addr_ram(3 downto 0),
      clk => clk,
